...
@extend_schema_view(
    ...
    retrieve=extend_schema(description="Retorna os detalhes de um candidato específico"),
    create=extend_schema(description="Cria um novo candidato"),
    partial_update=extend_schema(description="Atualiza parcialmente um candidato"),
